<template>
    <div class="swiperpage">
        <vue-glide  :bullet="true" :breakpoints="{ 400: { perView: 1 }, 700: { perView: 1 }, 1000: { perView: 1 }, 1200: { perView: 1 } }" v-model="active" v-bind="carouselOptions" v-if="movieList.length > 0">
            ...
            <vue-glide-slide v-for="(value, index) in movieList" :key="index"> <Singleswiperpage :_obj="value" /></vue-glide-slide>
        </vue-glide>
    </div>
</template>
